...
func TestRefScope_IsTheContextSeenAsAScope(t *testing.T) {
	t.Parallel()
	c := lowering.New(0, openapitest.DocDeclaring("User"), ir.SourceInfo{Path: "spec.yaml"}, "", overlay.Origin{})
...
func TestSources_ListsTheOverlayAfterTheSourceItPatched(t *testing.T) {
	...
	c := lowering.New(0, openapitest.DocDeclaring(), src, "", origin)
...
func TestSources_ListsOnlyTheSourceWhenNoOverlayApplied(t *testing.T) {
	...
	c := lowering.New(0, openapitest.DocDeclaring(), src, "", overlay.Origin{})
...
func TestProvenanceAt_NamesTheOverlayForThePositionsItIntroduced(t *testing.T) {
	...
	c := lowering.New(0, openapitest.DocDeclaring(), ir.SourceInfo{}, "", origin)
