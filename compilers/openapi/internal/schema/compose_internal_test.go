...
func TestMappingTargetID(t *testing.T) {
	t.Parallel()
	l := &lowerer{
		ctx: lowering.New(0, docDeclaring("Cat", "Dog", "A/B"), ir.SourceInfo{}, "", lowering.ExtensionPromotions{}, overlay.Origin{}),
	...
	empty := lowering.New(0, docDeclaring(""), ir.SourceInfo{}, "", lowering.ExtensionPromotions{}, overlay.Origin{})
